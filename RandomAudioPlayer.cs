...
namespace Gamekit3D
{
    ...
    {
        [Serializable] // says serializable, but I dont see them in the unity editor
        ...
        protected AudioSource m_Audiosource; // meaning behind protected?
        ...
        void Awake()
        {
            ...
            {
                foreach (var material in overrides[i].materials) // looking up audio banks for each material type
